  ...
  return (
    <section className="mb-12 md:mb-16">
      <h2 className="text-2xl font-bold text-white mb-4">
        <span className="text-mGreen">##</span> Professional Summary
      </h2>
      <div className="bg-#003b00 p-6 rounded-lg border border-mGreen/20">
        <p className="text-mGray leading-relaxed">
          With <span className="text-mGreen font-semibold">14 years in software engineering</span>, I&apos;ve worked across the full stack,
        ...
        <p className="text-mYellow leading-relaxed mt-4 font-semibold">
