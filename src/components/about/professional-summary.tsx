  ...
  return (
    <section className="mb-12 md:mb-16">
      <h2 className="text-2xl font-bold text-white mb-4">
        <span className="text-mPurple">##</span> Professional Summary
      </h2>
      <div className="bg-backgroundLight p-6 rounded-lg border border-mGray/20">
        <p className="text-mGray leading-relaxed">
          With <span className="text-mPurple font-semibold">14 years in software engineering</span>, I&apos;ve worked across the full stack, 
        ...
        <p className="text-mGray leading-relaxed mt-4">
        ...
        <p className="text-mGreen leading-relaxed mt-4 font-semibold">
