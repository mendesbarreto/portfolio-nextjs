  ...
  return (
    <section className="mb-12 md:mb-16">
      <h2 className="text-2xl font-bold text-white mb-4">
        <span className="text-mPurple">##</span> Management Skills
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {skills.map((skill, index) => (
          <div key={index} className="bg-backgroundLight p-4 rounded-lg border border-mGray/20 hover:border-mPurple/50 transition-colors">
